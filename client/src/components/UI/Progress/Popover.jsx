        ...
        <div>
            {
                dataResult.map(x=>{
                    if(x.check === true){
                        return (
                            <p className="text-success"><img src={process.env.PUBLIC_URL + '/img/tick.png'} height="15" width="15" className="mb-1"/>   {x.ten_trieuchung} vị trí {x.vitri}</p>
                        )
                    }else{
                        return (
                            <p className="text-danger"> <img src={process.env.PUBLIC_URL + '/img/negative.png'} height="15" width="15" className="mb-1"/> {x.ten_trieuchung} vị trí {x.vitri}</p>
                        )
                    }
                })
            }
