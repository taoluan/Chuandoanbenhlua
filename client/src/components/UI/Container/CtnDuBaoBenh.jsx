      ...
      <MDBContainer>
        {
          props.results.map((x,key)=>{
              if(x.ten_loai === "Vi Khuẩn"){
                return(
                  <>
                  <MDBRow key={key} className="mt-4 mb-4">
                ...
                return(
                  ...
                  <MDBRow className="mt-4 mb-2">
                    <MDBCol sm="5" className="d-flex align-items-center justify-content-center ">
                      <div className=" indigo lighten-4 z-depth-1 d-flex align-items-center justify-content-center rounded-circle" style={{height: "300px" ,  width : "300px"}}>
                          <Icon.ThieuChatDD  height="200" width="200"/>
                      </div>
                    </MDBCol>
                    <MDBCol sm="7">
                      <MDBRow className="d-flex justify-content-center">
